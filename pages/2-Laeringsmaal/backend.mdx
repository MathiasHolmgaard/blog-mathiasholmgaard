...
- Opnå dyb forståelse af microservices-patterns  [Artikel](/4-Artikler/backend/micro-services)
- Opnå dyb forståelse af Docker containerisering. [Artikel](/4-Artikler/backend/docker-containers)  
- Forstå forskellige kommunikationsmønstre (synkron og asynkron) og deres anvendelse i microservices-arkitektur. [Artikel](/4-Artikler/backend/microservice-kommunikation)
